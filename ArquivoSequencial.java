...
public interface ArquivoSequencial<T> {
    ...
    // Remover um registro específico do arquivo.
    boolean removerRegistro(String identificador) throws IOException, ClassNotFoundException;

    // Atualizar um registro existente no arquivo.
    boolean atualizarRegistro(T registroAtualizado) throws IOException, ClassNotFoundException;
}
